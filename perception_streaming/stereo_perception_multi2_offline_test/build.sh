...
if [ -f "${BUILD_DIR}/offline_test_main" ]; then
    ...
    echo "Usage:"
    echo "  cd ${BUILD_DIR}"
    echo "  ./offline_test_main <input_dir> <output_dir> [hardware_mode]"
    echo ""
    echo "Example:"
    echo "  ./offline_test_main /path/to/images ./output k100"
    echo "  ./offline_test_main /path/to/images ./output bestmow"
    echo "========================================="
else
    echo ""
